...
export function VitalMethod() {
  ...
  return (
    <section id="metodo-vital" className="py-16 md:py-24 lg:py-28 bg-background relative overflow-hidden">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-16 mb-16 items-center lg:items-start">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-white/80 font-sans">
              5 Pilares para alcançar um <span className="text-[#fab31b] font-bold italic">resultado real e permanente.</span>
            </p>
          </div>
          ...
          <div className="pt-2 flex justify-center lg:justify-start">
            <p className="text-base md:text-lg text-white/40 font-light leading-relaxed 
              ...
              Saúde de verdade não é sobre tentar de tudo, é sobre entender o que o seu corpo realmente precisa. A verdade é simples: Seu corpo não precisa de mais tentativas. Ele precisa de estratégia, avaliação e ajuste real.
            </p>
          </div>
        </div>
          ...
          {pillars.map((p, i) => (
            <motion.div
              ...
              className="glass-card p-8 flex flex-col items-center text-center group 
                         ...
                         transition-all duration-500 cursor-pointer h-[420px] relative overflow-hidden"
            >
              ...
              {/* 2. TÍTULO COM BRILHO INTERNO (SHINE TEXT) */}
              <div className="h-16 flex items-center justify-center mb-4 relative z-10 w-full">
                <motion.h3 
                  ...
                  transition={{ 
                    ...
                    repeat: Infinity, 
                    ease: "linear",
                    delay: i * 0.8 // Cria o efeito de "onda" passando de um card para o outro
                  }}
                >
                  {p.title}
                </motion.h3>
